...
export function CalendarConnectionEmpty({
    ...
    return (
      <div className="px-6 py-8 text-center">
        ...
        <Link
          ...
          className="mt-3 inline-block text-xs font-semibold text-primary hover:text-primary"
        >
          Open integrations →
        </Link>
      </div>
  ...
  return (
    <div className="app-card flex min-h-0 flex-1 flex-col justify-center p-8 text-center">
      ...
      <Link
        href="/settings/integrations"
        className="mt-4 inline-block rounded-2xl bg-primary px-5 py-2.5 text-sm font-semibold text-white hover:bg-[var(--color-primary-hover)]"
      >
        Connect in Settings
      </Link>
    </div>
