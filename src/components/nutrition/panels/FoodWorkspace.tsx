...
const FoodRow = memo(function FoodRow({
  ...
  return (
    ...
    >
      ...
      <td className="hidden px-4 py-3 text-right font-bold tabular-nums text-violet-600 md:table-cell">
            ...
            <div className="flex items-center rounded-xl border border-slate-100 bg-white p-0.5 shadow-sm">
              {(["most-logged", "latest", "az"] as const).map((s) => (
                <button
                  ...
                  type="button"
                  onClick={() => setSort(s)}
                  className={`rounded-lg px-2.5 py-1 text-[11px] font-semibold transition-colors ${sort === s
            ...
            <table className="w-full border-collapse text-sm">
              <thead>
                <tr className="border-b border-slate-100">
                  ...
                  <th className="hidden w-10 px-2 py-3 md:table-cell" aria-label="Actions" />
                </tr>
              </thead>
                            ...
                            <div className="flex flex-col gap-2.5">
                              <div className="flex flex-wrap items-center gap-2">
                                <button
                                  ...
                                  className="flex h-8 w-8 items-center justify-center rounded-lg text-lg text-slate-600 hover:bg-white"
                                ...
                                {logError && (
                                  <span className="w-full text-xs text-red-500">{logError}</span>
                                )}
                              </div>
